  ...
  <div>
    ...
    <!--<div class="uc-header-bg">-->
      <!--<div class="uc-header wrapper">-->
        <!--<a class="logo" href="index.html"><img src="../../static/img/logo2.png" alt="" /></a>-->
            ...
            <div class="uc-panel-bd">
              ...
              <div class="safe-list">
                <div class="list-item">
                  ...
                  <div class="cont">
                    <img src="../../static/img/uc/pwd.jpg" class="ico" />
                ...
                <div class="list-item">
                  <a href="uc-verify.html" class="edit ui-btn-low ui-btn-hollow uc-btn-md">修改</a>
                  <div class="cont">
                    <img src="../../static/img/uc/mail.jpg" class="ico" />
                ...
                <div class="list-item">
                  <a href="uc-verify.html" class="edit ui-btn-low ui-btn-hollow uc-btn-md">修改</a>
                  <div class="cont">
                    <img src="../../static/img/uc/phone.jpg" class="ico" />
                ...
                <div class="list-item">
                  <a href="uc-verify.html" class="edit ui-btn-low ui-btn-hollow uc-btn-md">修改</a>
                  <div class="cont">
                    <img src="../../static/img/uc/safe.jpg" class="ico" />
...
<script>
  ...
  import '../../static/js/laydate/laydate'
  import '../../static/css/iconfont/iconfont.css'
  import '../../static/css/common.css'
  import '../../static/css/uc.css'
  export default {
