      ...
      <div class="confirm-address clearfix">
        <div class="col col-4">
          <div class="item active">
            ...
            <div class="info">
              <div class="ellipsis"><img src="../../static/img/ico/user.jpg" alt="" />安徽合肥（唐霞 收）</div>
              <div class="ellipsis"><img src="../../static/img/ico/dizhi.jpg" alt="" />高新长江西路拓基城市广场金座A2002</div>
              <div class="ellipsis"><img src="../../static/img/ico/tel.jpg" alt="" />15866887799</div>
            </div>
          </div>
        </div>
        <div class="col col-4">
